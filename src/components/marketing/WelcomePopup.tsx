  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={close}
          style={{ position: "absolute", top: "14px", right: "14px", background: "rgba(255,255,255,0.08)", border: "none", borderRadius: "999px", width: "32px", height: "32px", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#fff", zIndex: 2 }}
        >
          <X size={16} />
        </button>
        ...
        <div style={{ padding: "40px 36px 36px", position: "relative", zIndex: 1 }}>
          ...
          {!submitted ? (
            <>
              <p style={{ fontSize: "11px", fontWeight: 800, letterSpacing: "0.28em", textTransform: "uppercase", color: "#d97706", marginBottom: "10px" }}>
                Offre de bienvenue
              </p>
              <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "clamp(22px,5vw,28px)", fontWeight: 700, color: "#fff", lineHeight: 1.2, margin: "0 0 10px" }}>
                -10% sur votre<br />première commande
              </h2>
              <p style={{ fontSize: "14px", color: "rgba(253,230,138,0.80)", lineHeight: 1.6, marginBottom: "24px" }}>
              ...
              <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  style={{ background: "linear-gradient(135deg, #d97706, #f59e0b)", color: "#fff", border: "none", borderRadius: "10px", padding: "14px", fontSize: "14px", fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", opacity: loading ? 0.7 : 1 }}
                >
                  {loading ? <Loader2 size={16} style={{ animation: "spin 1s linear infinite" }} /> : "Obtenir mon code -10%"}
                </button>
              </form>
            ...
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "24px", fontWeight: 700, color: "#fff", marginBottom: "12px" }}>
                Votre code est prêt !
              </h2>
              <div style={{ background: "rgba(217,119,6,0.15)", border: "1px dashed rgba(217,119,6,0.50)", borderRadius: "10px", padding: "16px", marginBottom: "16px" }}>
                ...
                <p style={{ fontSize: "26px", fontWeight: 900, color: "#fff", letterSpacing: "0.12em", fontFamily: "monospace" }}>{PROMO_CODE}</p>
              </div>
              <p style={{ fontSize: "13px", color: "rgba(253,230,138,0.80)" }}>
                Copiez ce code et appliquez-le au moment du paiement.
              </p>
              <button
                onClick={close}
                style={{ marginTop: "20px", background: "linear-gradient(135deg, #d97706, #f59e0b)", color: "#fff", border: "none", borderRadius: "10px", padding: "12px 28px", fontSize: "14px", fontWeight: 700, cursor: "pointer" }}
              >
                Voir le catalogue
              </button>
            </div>
